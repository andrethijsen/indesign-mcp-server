...
class InDesignMCPServer {
  ...
  async executeInDesignScript(script) {
    ...
    try {
      ...
      // to avoid the French macOS 'do script' syntax conflict
      const jxaScript = `
        var app = Application("Adobe InDesign 2026");
        app.activate();
        ObjC.import('Foundation');
        var fileContent = $.NSString.stringWithContentsOfFileEncodingError("${tempScript}", $.NSUTF8StringEncoding, null).js;
        app.doScript(fileContent, {language: "javascript"});
      `;
